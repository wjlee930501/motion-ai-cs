...
export function TemplatesModal({ isOpen, onClose }: TemplatesModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      {/* Modal */}
      <div className="absolute inset-4 md:inset-8 lg:inset-12 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 rounded-2xl shadow-2xl overflow-hidden flex flex-col">
        {/* Header */}
